...
const images = Array.from({ length: 13 }, (_, i) => `/images/fullbath-${i + 1}.jpg`);

export default function FullBathGallery() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-gray-950 pt-[140px] md:pt-[200px] pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Explore our complete bathroom transformations. From design to installation,
            see the quality and craftsmanship Padilla Prestige Remodeling delivers in every project.
          </motion.p>
          <motion.div
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
      ...
      >
        <p className="text-gray-500 text-lg mb-6">Ready to transform your entire bathroom?</p>
        <Link
          href="/#consultation"
        ...
        {lightbox !== null && (
          ...
          >
            ...
            <motion.img
              ...
              transition={{ duration: 0.25 }}
              src={images[lightbox]}
              alt={`Full bathroom remodel ${lightbox + 1}`}
