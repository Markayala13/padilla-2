    ...
    <section className="bg-[#1a1a1a] text-white py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          {/* Right: fine print */}
          <div className="flex-1 max-w-sm bg-white/5 border border-white/10 p-6">
            ...
            <ul className="space-y-3 text-sm text-white/60">
              <li className="flex gap-2">
                ...
                Loans through Regions Bank d/b/a EnerBank USA, Member FDIC
              </li>
              <li className="flex gap-2">
                <span className="text-[#E07B00] font-bold shrink-0">✓</span>
            ...
            <p className="text-xs text-white/30 mt-4 leading-relaxed">
              *Loans provided by Regions Bank d/b/a EnerBank USA, Member FDIC
              (650 S. Main St., Suite 1000, Salt Lake City, UT 84101-2844).
              Fixed APR, effective after promotional period ends and subject to
              change. Interest starts accruing when the loan closes.
            </p>
          </div>
        </div>
      </div>
